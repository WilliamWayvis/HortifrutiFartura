      ...
      <div className="flex-1 min-h-0 p-[2vw] flex gap-[2vw] overflow-hidden">
                ...
                carnesQueue.slice(0, 5).map((item, idx) => (
                  ...
                  >
                    ...
                    <span
                      ...
                      className={`font-black ${item.priority ? 'text-blue-700' : 'text-red-700'}`}
                    >
                      {item.code}
                    </span>
                    {item.priority && (
        ...
        <div className="w-[58%] min-w-0 flex flex-col gap-[2vh]">
          <div className="text-center flex-shrink-0">
            <h1 style={{ fontSize: 'clamp(1.5rem,5vw,5rem)' }} className="font-black text-gray-800 leading-none">AÇOUGUE</h1>
          </div>
          <div
